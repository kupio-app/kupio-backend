...
from src.domains.chat.enums import DevicePlatform
from src.domains.chat.models import Conversation, DeviceToken, Message
...
class DeviceTokensRepository(BaseRepository):
    ...
    async def touch_last_seen(self, token_id: UUID) -> None:
        await self._update(
            DeviceToken,
    ...
    async def get_tokens_for_user(self, user_id: UUID) -> list[DeviceToken]:
